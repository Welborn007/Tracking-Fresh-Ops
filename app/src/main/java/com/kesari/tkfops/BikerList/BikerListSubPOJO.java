...
public class BikerListSubPOJO {
    ...
    private BikerListAddressPOJO address;
    ...
    public BikerListAddressPOJO getAddress() {
        return address;
    }

    public void setAddress(BikerListAddressPOJO address) {
