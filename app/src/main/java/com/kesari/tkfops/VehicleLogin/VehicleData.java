...
public class VehicleData {
    ...
    private String gps_vehicle_status;
    ...
    public String getGps_vehicle_status() {
        return gps_vehicle_status;
    }

    public void setGps_vehicle_status(String gps_vehicle_status) {
        this.gps_vehicle_status = gps_vehicle_status;
    }
