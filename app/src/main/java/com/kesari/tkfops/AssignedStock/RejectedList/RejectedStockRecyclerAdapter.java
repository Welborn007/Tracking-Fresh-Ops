...
public class RejectedStockRecyclerAdapter extends RecyclerView.Adapter<RejectedStockRecyclerAdapter.RecyclerViewHolder>{

    private List<RejectedListSubPojo> OrdersListReView;
    Context context;
    private String TAG = this.getClass().getSimpleName();

    public RejectedStockRecyclerAdapter(List<RejectedListSubPojo> OrdersListReView, Context context)
    {
    ...
    @Override
    public RejectedStockRecyclerAdapter.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.stock_accepted_rejected_row,parent,false);

        RejectedStockRecyclerAdapter.RecyclerViewHolder recyclerViewHolder = new RejectedStockRecyclerAdapter.RecyclerViewHolder(view);

        return recyclerViewHolder;
    }

    @Override
    public void onBindViewHolder(RejectedStockRecyclerAdapter.RecyclerViewHolder holder, final int position) {
