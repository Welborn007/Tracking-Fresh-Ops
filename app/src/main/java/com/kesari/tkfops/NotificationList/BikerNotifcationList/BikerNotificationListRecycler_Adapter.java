...
public class BikerNotificationListRecycler_Adapter extends RecyclerView.Adapter<BikerNotificationListRecycler_Adapter.RecyclerViewHolder>{

    private List<BikerNotificationSubPOJO> NotificationListReView;
    private String TAG = this.getClass().getSimpleName();
    private Context context;

    public BikerNotificationListRecycler_Adapter(List<BikerNotificationSubPOJO> NotificationListReView, Context context)
    {
    ...
    @Override
    public BikerNotificationListRecycler_Adapter.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.notification_row_layout,parent,false);

        BikerNotificationListRecycler_Adapter.RecyclerViewHolder recyclerViewHolder = new BikerNotificationListRecycler_Adapter.RecyclerViewHolder(view);

        return recyclerViewHolder;
    }

    @Override
    public void onBindViewHolder(BikerNotificationListRecycler_Adapter.RecyclerViewHolder holder, final int position) {
