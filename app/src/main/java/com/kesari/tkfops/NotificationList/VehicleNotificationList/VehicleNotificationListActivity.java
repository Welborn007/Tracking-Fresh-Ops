...
public class VehicleNotificationListActivity extends AppCompatActivity implements NetworkUtilsReceiver.NetworkResponseInt{
    ...
    VehicleNotificationMainPOJO vehicleNotificationMainPOJO;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try
        {
            ...
            Orders = new LinearLayoutManager(VehicleNotificationListActivity.this);
            ...
            swipeContainer.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    ...
                    getNotificationList(VehicleNotificationListActivity.this);
                }
            });
            ...
            {
                IOUtils.buildAlertMessageNoGps(VehicleNotificationListActivity.this);
            }
            else
            {
      ...
      public void getNotificationList(final Context context)
    {
        try
        {
            ...
            String url = "";
            url = Constants.VehicleNotificationList;
            ...
            ioUtils.getGETStringRequestHeader(context, url , params , new IOUtils.VolleyCallback() {
                ...
                public void onSuccess(String result) {
                    ...
                    getNotificationListResponse(result,VehicleNotificationListActivity.this);
    ...
    public void getNotificationListResponse(String Response,Context context)
    {
        try
        {
            vehicleNotificationMainPOJO = gson.fromJson(Response, VehicleNotificationMainPOJO.class);
            valueTV = new TextView(context);

            if(vehicleNotificationMainPOJO.getData().isEmpty())
            {
                adapterOrders = new VehicleNotificationListRecycler_Adapter(vehicleNotificationMainPOJO.getData(),context);
